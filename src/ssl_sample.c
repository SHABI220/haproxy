...
static struct sample_fetch_kw_list sample_fetch_keywords = {ILH, {
	...
	{ "ssl_fc_supported_versions_bin", smp_fetch_ssl_fc_supver_bin,    0,          NULL,    SMP_T_BIN,  SMP_USE_L5CLI },
	{ "ssl_fc_sigalgs_bin",     smp_fetch_ssl_fc_sigalgs_bin, 0,                   NULL,    SMP_T_BIN,  SMP_USE_L5CLI },
